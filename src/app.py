...
activities = {
    ...
    "Soccer Club": {
        "description": "Join our soccer team for practices and matches",
    ...
    "Art Studio": {
        "description": "Create paintings, sculptures, and other artistic works",
    ...
    "Robotics Club": {
        ...
        "max_participants": 20,
        "participants": ["cameron@mergington.edu", "blake@mergington.edu", "drew@mergington.edu"]
    }
}
...
def signup_for_activity(activity_name: str, email: str):
    ...
    if email in activity["participants"]:
        raise HTTPException(status_code=400, detail="You are already registered for this activity")
